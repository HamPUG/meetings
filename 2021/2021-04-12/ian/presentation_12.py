...
class MyWindow(Gtk.Window):
    def __init__(self):
        Gtk.Window.__init__(self, title="Gtk Presentation # 12")        
        ...
        self.hb.props.title = "Gtk Presentation # 12"
    ...
    def on_button_clicked(self, button, identifier):
        ...
        # 12. Button 0 launches the Message box.
        if identifier == 0:
            self.message_dialog_1()
        
    # 12. Add a Message box.
