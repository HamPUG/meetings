...
def add_provider(widget):
    # 9. Provide the CSS for labels and frames.
    ...
    /* 9. Add more CSS. For Frame and Buttons */         
    .frame_second {
        margin: 10px;
...
class MyWindow(Gtk.Window):
    def __init__(self):
        ...
        # 9. Align Frame label to centre. Range 0.0 to 1.0
