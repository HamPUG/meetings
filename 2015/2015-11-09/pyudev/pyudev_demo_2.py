#!/usr/bin/env python
#
# Program: pyudev_demo_2.py
# Author: Ian Stewart
# Date: 2015-Nov-09
# Tab = 4 x spaces
#
# Objective: Demonstrate pyudev detecting removal and insertion of a USB device
