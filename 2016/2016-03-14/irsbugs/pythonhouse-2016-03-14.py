...
#
# Description:
# Python script that will launch a impress document using the socket connection 
# and then draw a picture comprised of rectangles and ellipses.
# 
# Written for: Hamilton Python User Group - Presentation 14-March-2016
